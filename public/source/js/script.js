document.addEventListener("DOMContentLoaded", function(event) {
     ...
     */
    var peer = new Peer({
        host: "10.10.128.153", //TODO: replace the server https://github.com/peers/peerjs-server
        port: 9000,
        path: '/peerjs',
        debug: 3,
        config: {
            'iceServers': [
                { url: 'stun:stun2.l.google.com:19302' },
                {
                    ...
                    credential: 'P@ssw0rd00',
                    username: 'maxim.stanciu@live.com'
                }
            ]
        }
    });
    ...
    peer.on('call', function (call) {
        var acceptsCall = confirm("Videocall, accept ?");
    ...
    document.getElementById("disconnect").addEventListener("click", function(){
        var disconnectCall = confirm("Hang Up?");
